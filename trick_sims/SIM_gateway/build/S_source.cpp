...
/* Created 2019/09/24 16:35:54 amalatak $ */
#include "../S_source.hh"
...
int OrbiterSimObject::call_function ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 0:
            orbiter_default_data( &orbiter ) ;
            break ;
        case 1:
            orbiter_init( &orbiter ) ;
            break ;
        case 2:
            orbiter_deriv( &orbiter) ;
            break ;
        case 3:
            trick_ret= orbiter_integ( & orbiter) ;
            break ;
        case 4:
            orbiter_shutdown( &orbiter ) ;
            break ;
        default:
            trick_ret = -1 ;
            break ;
...
double OrbiterSimObject::call_function_double ( Trick::JobData * curr_job ) {
...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_HOME"] = "/home/amalatak/repo/trick";
    ...
    local_env["TRICK_PATH"] = "/home/amalatak/repo/trick/libexec/bin";
    ...
    local_env["TRICK_SYSTEM_CFLAGS"] = "-I/home/amalatak/repo/trick/trick_source -I/home/amalatak/repo/trick/include -I/home/amalatak/repo/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=1 -fpic  -DUSE_ER7_UTILS_INTEGRATORS -fexceptions ";
    setenv("TRICK_SYSTEM_CFLAGS", local_env["TRICK_SYSTEM_CFLAGS"].c_str(), 0);
    local_env["TRICK_SYSTEM_CXXFLAGS"] = "-I/home/amalatak/repo/trick/trick_source -I/home/amalatak/repo/trick/include -I/home/amalatak/repo/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=1 -fpic  -DUSE_ER7_UTILS_INTEGRATORS ";
    ...
    local_env["TRICK_USER_CSHRC"] = "/home/amalatak/.Trick_user_cshrc";
    setenv("TRICK_USER_CSHRC", local_env["TRICK_USER_CSHRC"].c_str(), 0);
    local_env["TRICK_USER_HOME"] = "/home/amalatak/trick_sims";
    ...
    local_env["TRICK_USER_PROFILE"] = "/home/amalatak/.Trick_user_profile";
    ...
    local_env["XML_CATALOG_FILES"] = "/home/amalatak/repo/trick/libexec/trick_source/data_products/DPX/XML/catalog.xml";
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 19.1.dev, Tue Sep 24 16:35:54 2019" ) ;
    exec_set_build_date( "Tue Sep 24 16:35:54 2019" ) ;
    exec_set_current_version( "19.1.dev" ) ;
    ...
    TMM_declare_ext_var(&dyn, TRICK_STRUCTURED,"OrbiterSimObject", 0, "dyn", 0, NULL) ;
