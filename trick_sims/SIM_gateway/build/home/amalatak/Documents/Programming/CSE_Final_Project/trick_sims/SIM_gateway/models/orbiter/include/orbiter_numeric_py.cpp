...
/*-----------------------------------------------
              @(target):= _m4e2ba54134d357f6443bf075f8a67623.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__m4e2ba54134d357f6443bf075f8a67623

#else
#  define SWIG_init    init_m4e2ba54134d357f6443bf075f8a67623

#endif
#define SWIG_name    "_m4e2ba54134d357f6443bf075f8a67623"
...
SWIGINTERN PyObject *_wrap_orbiter_integ(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ORBITER *arg1 = (ORBITER *) 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:orbiter_integ",&obj0)) SWIG_fail;
  {
    // ORBITER *
    void * temp_ptr ;
  ...
  result = (int)orbiter_integ(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "orbiter_integ" ;
...
SWIGINTERN PyObject *_wrap_orbiter_deriv(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ORBITER *arg1 = (ORBITER *) 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:orbiter_deriv",&obj0)) SWIG_fail;
  {
    // ORBITER *
    void * temp_ptr ;
  ...
  result = (int)orbiter_deriv(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "orbiter_deriv" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_int out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_int out found units " << t->units << std::endl ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"orbiter_integ", _wrap_orbiter_integ, METH_VARARGS, NULL},
	 { (char *)"orbiter_deriv", _wrap_orbiter_deriv, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
