%module m4fbc2b835aa824420d037a47086569f0
...
%{
#include "/home/amalatak/Documents/Programming/CSE_Final_Project/trick_sims/SIM_gateway/S_source.hh"
%}
...
%trick_swig_class_typemap(OrbiterSimObject, OrbiterSimObject)
...
%import "build/home/amalatak/Documents/Programming/CSE_Final_Project/trick_sims/SIM_gateway/models/orbiter/include/orbiter_numeric_py.i"
...
class SysSimObject : public Trick::SimObject {
    ...
    public:
        ...
        SysSimObject() {
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 11, "dmtcp_restart", NULL, 1, "sched.write_s_job_execution", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 12, "dmtcp_restart", NULL, 1, "sched.write_s_run_summary", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 13, "system_moding", NULL, 1, "sched.sched_freeze_to_exec_command", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 14, "end_of_frame", NULL, 1, "sched.sched_freeze_to_exec_command", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 15, "end_of_frame", NULL, 1, "sched.async_freeze_to_exec_command", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 16, "freeze_init", NULL, 1, "sched.init_freeze_scheduled", "", 60000) ;
            job = this->add_job(0, 17, "system_advance_sim_time", NULL, 1, "sched.advance_sim_time", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 18, "system_thread_sync", NULL, 1, "sched.thread_sync", "", 60000) ;
            job->add_tag("TRK") ;
        }
...
exec_register_scheduler(&cpr) ;
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 4, "top_of_frame", NULL, 1, "cpr.write_dmtcp_checkpoint", "", 0) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 5, "system_checkpoint", NULL, 1, "cpr.safestore_checkpoint", "", 0) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 6, "shutdown", NULL, 1, "cpr.write_end_checkpoint", "", 0) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 7, "freeze", NULL, 1, "cpr.load_checkpoint_job", "", 0) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 8, "end_of_frame", NULL, 1, "cpr.load_checkpoint_job", "", 0) ;
            job->add_tag("TRK") ;
        }
...
class OrbiterSimObject : public Trick::SimObject {
    ...
    public:
        ...
        OrbiterSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "orbiter_default_data", "", 60000) ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "orbiter_init", "", 60000) ;
            job = this->add_job(0, 2, "derivative", NULL, 1, "orbiter_deriv", "", 60000) ;
            job = this->add_job(0, 3, "integration", NULL, 1, "orbiter_integ", "", 60000) ;
            job = this->add_job(0, 4, "shutdown", NULL, 1, "orbiter_shutdown", "", 60000) ;
        }
...
#define TRICK_SWIG_DEFINED_OrbiterSimObject
...
#endif
#ifdef TRICK_SWIG_DEFINED_OrbiterSimObject
%trick_cast_as(OrbiterSimObject, OrbiterSimObject)
#endif
