...
#define SWIGTYPE_p_ORBITER swig_types[32]
#define SWIGTYPE_p_OrbiterSimObject swig_types[33]
...
/*-----------------------------------------------
              @(target):= _m4fbc2b835aa824420d037a47086569f0.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__m4fbc2b835aa824420d037a47086569f0

#else
#  define SWIG_init    init_m4fbc2b835aa824420d037a47086569f0

#endif
#define SWIG_name    "_m4fbc2b835aa824420d037a47086569f0"
...
SWIGINTERN PyObject *OrbiterSimObject___getitem__(OrbiterSimObject *self,int ii){
        ...
        //std::cout << "HERE in class __getitem__!!!" << std::endl ;
        resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(&self[ii]), SWIG_TypeQuery("OrbiterSimObject *"), 0);
        return(resultobj) ;
    }
SWIGINTERN PyObject *OrbiterSimObject___len__(OrbiterSimObject *self){
        // get_size only works if "self" was an allocated pointer
        return PyInt_FromLong(get_size((char *)self)) ;
    }
...
/* caseAs##OrbiterSimObject casts incoming ptrs as the target type.  Takes incoming object and tests if it
   is a compatible type, a void *, or an integer (raw pointer value).  If it is any of these
   types it returns the incoming value as a pointer to the outgoing type.  The integer
   conversion is used by the input processor to associate named allocations in the
   memory manager to names in pyton space.
 */
OrbiterSimObject * castAsOrbiterSimObject( PyObject * obj1 ) {
    void *argp = NULL ;
    OrbiterSimObject * ret = (OrbiterSimObject *)NULL ;

    //std::cout << "calling __cast_as" << std::endl ;
    if ( SWIG_IsOK(SWIG_ConvertPtr(obj1,&argp,SWIG_TypeQuery("OrbiterSimObject *"),SWIG_POINTER_DISOWN)) ) {
        //std::cout << "we can cast to OrbiterSimObject! " << argp << std::endl ;
        ret = reinterpret_cast< OrbiterSimObject *>(argp) ;
    } else if (SWIG_IsOK(SWIG_ConvertPtr(obj1, &argp,SWIG_TypeQuery("void *"), 0 ))) {
        //std::cout << "we can cast (wrapped void *) to OrbiterSimObject! " << argp << std::endl ;
        ret = reinterpret_cast< OrbiterSimObject *>(argp) ;
    } else if ( PyInt_Check(obj1) ) {
        ret = reinterpret_cast< OrbiterSimObject *>( PyInt_AsLong(obj1) ) ;
        //std::cout << "we are using incoming value as address " << PyInt_AsLong(obj1) << std::endl ;
    } else {
        std::cout << "Cast to OrbiterSimObject failed." << std::endl ;
    }
    return ret ;
}
...
SWIGINTERN PyObject *_wrap_OrbiterSimObject_orbiter_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  OrbiterSimObject *arg1 = (OrbiterSimObject *) 0 ;
  ORBITER *arg2 = (ORBITER *) 0 ;
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OO:OrbiterSimObject_orbiter_set",&obj0,&obj1)) SWIG_fail;
  {
    // OrbiterSimObject *
    void * temp_ptr ;
    
    if ( SWIG_IsOK(SWIG_ConvertPtr(obj0, &temp_ptr,SWIGTYPE_p_OrbiterSimObject, SWIG_POINTER_DISOWN)) ) {
      arg1 = reinterpret_cast< OrbiterSimObject * >(temp_ptr) ;
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(obj0, &temp_ptr,SWIG_TypeQuery("_p_swig_ref"), 0)) ) {
      // Array to pointer assignment
      swig_ref * temp_swig_ref = reinterpret_cast< swig_ref * >(temp_ptr);
      if ( temp_swig_ref != NULL ) {
        arg1 = reinterpret_cast< OrbiterSimObject * >(temp_swig_ref->ref.address) ;
      }
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(obj0, &temp_ptr,SWIG_TypeQuery("_p_REF2"), 0)) ) {
      // We have an address coming in, we don't have to do any translation
      REF2 * temp_ref = reinterpret_cast< REF2 * >(temp_ptr) ;
      if ( temp_ref != NULL ){
        arg1 = reinterpret_cast< OrbiterSimObject * >(temp_ref->address) ;
      }
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(obj0, &temp_ptr,SWIG_TypeQuery("_p_void"), 0)) ) {
      // We have an address coming in, we don't have to do any translation
      arg1 = reinterpret_cast< OrbiterSimObject * >(temp_ptr) ;
  ...
  }
  {
    ...
    if ( SWIG_IsOK(SWIG_ConvertPtr(obj1, &temp_ptr,SWIGTYPE_p_ORBITER, SWIG_POINTER_DISOWN)) ) {
      arg2 = reinterpret_cast< ORBITER * >(temp_ptr) ;
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(obj1, &temp_ptr,SWIG_TypeQuery("_p_swig_ref"), 0)) ) {
      // Array to pointer assignment
      swig_ref * temp_swig_ref = reinterpret_cast< swig_ref * >(temp_ptr);
      if ( temp_swig_ref != NULL ) {
        arg2 = reinterpret_cast< ORBITER * >(temp_swig_ref->ref.address) ;
      }
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(obj1, &temp_ptr,SWIG_TypeQuery("_p_REF2"), 0)) ) {
      // We have an address coming in, we don't have to do any translation
      REF2 * temp_ref = reinterpret_cast< REF2 * >(temp_ptr) ;
      if ( temp_ref != NULL ){
        arg2 = reinterpret_cast< ORBITER * >(temp_ref->address) ;
      }
...
SWIGINTERN PyObject *_wrap_OrbiterSimObject_orbiter_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  OrbiterSimObject *arg1 = (OrbiterSimObject *) 0 ;
  PyObject * obj0 = 0 ;
  ORBITER *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:OrbiterSimObject_orbiter_get",&obj0)) SWIG_fail;
  {
    // OrbiterSimObject *
    void * temp_ptr ;
  ...
  result = (ORBITER *)& ((arg1)->orbiter);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ORBITER, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_new_OrbiterSimObject(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  OrbiterSimObject *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_OrbiterSimObject")) SWIG_fail;
  result = (OrbiterSimObject *)new OrbiterSimObject();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_OrbiterSimObject, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_OrbiterSimObject_call_function(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  OrbiterSimObject *arg1 = (OrbiterSimObject *) 0 ;
  Trick::JobData *arg2 = (Trick::JobData *) 0 ;
  void *argp2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:OrbiterSimObject_call_function",&obj0,&obj1)) SWIG_fail;
  {
    // OrbiterSimObject *
    void * temp_ptr ;
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_Trick__JobData, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "OrbiterSimObject_call_function" "', argument " "2"" of type '" "Trick::JobData *""'"); 
  }
  arg2 = reinterpret_cast< Trick::JobData * >(argp2);
  result = (int)(arg1)->call_function(arg2);
  {
    ...
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "OrbiterSimObject_call_function" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_int out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_int out found units " << t->units << std::endl ;
...
SWIGINTERN PyObject *_wrap_OrbiterSimObject_call_function_double(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  OrbiterSimObject *arg1 = (OrbiterSimObject *) 0 ;
  Trick::JobData *arg2 = (Trick::JobData *) 0 ;
  void *argp2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:OrbiterSimObject_call_function_double",&obj0,&obj1)) SWIG_fail;
  {
    // OrbiterSimObject *
    void * temp_ptr ;
  ...
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_Trick__JobData, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "OrbiterSimObject_call_function_double" "', argument " "2"" of type '" "Trick::JobData *""'"); 
  }
  arg2 = reinterpret_cast< Trick::JobData * >(argp2);
  result = (double)(arg1)->call_function_double(arg2);
  {
    ...
    swig_double * t = new swig_double ;
    t->value = (double)result ;
    temp_name = "OrbiterSimObject_call_function_double" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_double out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_double out found units " << t->units << std::endl ;
...
SWIGINTERN PyObject *_wrap_OrbiterSimObject___getitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  OrbiterSimObject *arg1 = (OrbiterSimObject *) 0 ;
  int arg2 ;
  PyObject * obj0 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:OrbiterSimObject___getitem__",&obj0,&obj1)) SWIG_fail;
  {
    // OrbiterSimObject *
    void * temp_ptr ;
  ...
  {
    int ret ;
    ret = typemap_in_scalar<int >( arg2 , obj1 , "OrbiterSimObject___getitem__") ;
    if ( ret != 0 ) {
      SWIG_exception_fail(SWIG_TypeError,"Right hand side could not be converted proper scalar type");
    }
  }
  result = (PyObject *)OrbiterSimObject___getitem__(arg1,arg2);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_OrbiterSimObject___len__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  OrbiterSimObject *arg1 = (OrbiterSimObject *) 0 ;
  PyObject * obj0 = 0 ;
  PyObject *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:OrbiterSimObject___len__",&obj0)) SWIG_fail;
  {
    // OrbiterSimObject *
    void * temp_ptr ;
  ...
  result = (PyObject *)OrbiterSimObject___len__(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_delete_OrbiterSimObject(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  OrbiterSimObject *arg1 = (OrbiterSimObject *) 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_OrbiterSimObject",&obj0)) SWIG_fail;
  {
    // OrbiterSimObject *
    void * temp_ptr ;
...
SWIGINTERN PyObject *OrbiterSimObject_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_OrbiterSimObject, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
SWIGINTERN PyObject *_wrap_castAsOrbiterSimObject(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PyObject *arg1 = (PyObject *) 0 ;
  PyObject * obj0 = 0 ;
  OrbiterSimObject *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:castAsOrbiterSimObject",&obj0)) SWIG_fail;
  arg1 = obj0;
  result = (OrbiterSimObject *)castAsOrbiterSimObject(arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_OrbiterSimObject, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"OrbiterSimObject_orbiter_set", _wrap_OrbiterSimObject_orbiter_set, METH_VARARGS, NULL},
	 { (char *)"OrbiterSimObject_orbiter_get", _wrap_OrbiterSimObject_orbiter_get, METH_VARARGS, NULL},
	 { (char *)"new_OrbiterSimObject", _wrap_new_OrbiterSimObject, METH_VARARGS, NULL},
	 { (char *)"OrbiterSimObject_call_function", _wrap_OrbiterSimObject_call_function, METH_VARARGS, NULL},
	 { (char *)"OrbiterSimObject_call_function_double", _wrap_OrbiterSimObject_call_function_double, METH_VARARGS, NULL},
	 { (char *)"OrbiterSimObject___getitem__", _wrap_OrbiterSimObject___getitem__, METH_VARARGS, NULL},
	 { (char *)"OrbiterSimObject___len__", _wrap_OrbiterSimObject___len__, METH_VARARGS, NULL},
	 { (char *)"delete_OrbiterSimObject", _wrap_delete_OrbiterSimObject, METH_VARARGS, NULL},
	 { (char *)"OrbiterSimObject_swigregister", OrbiterSimObject_swigregister, METH_VARARGS, NULL},
	 ...
	 { (char *)"castAsOrbiterSimObject", _wrap_castAsOrbiterSimObject, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static void *_p_OrbiterSimObjectTo_p_Trick__SimObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Trick::SimObject *)  ((OrbiterSimObject *) x));
}
...
static swig_type_info _swigt__p_OrbiterSimObject = {"_p_OrbiterSimObject", "OrbiterSimObject *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_OrbiterSimObject[] = {  {&_swigt__p_OrbiterSimObject, 0, 0, 0},{0, 0, 0, 0}};
