...
_sim_services.MAX_TRIADS_swigconstant(_sim_services)
MAX_TRIADS = _sim_services.MAX_TRIADS

_sim_services.MAX_UNITS_SPEC_STRLEN_swigconstant(_sim_services)
MAX_UNITS_SPEC_STRLEN = _sim_services.MAX_UNITS_SPEC_STRLEN

_sim_services.CONV_OK_swigconstant(_sim_services)
CONV_OK = _sim_services.CONV_OK

_sim_services.CONV_ERR_swigconstant(_sim_services)
