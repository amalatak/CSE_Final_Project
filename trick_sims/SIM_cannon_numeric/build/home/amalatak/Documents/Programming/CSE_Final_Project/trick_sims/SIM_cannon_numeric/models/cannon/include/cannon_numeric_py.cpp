...
/*-----------------------------------------------
              @(target):= _md90de8bdc9357de96137da391049d8b6.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__md90de8bdc9357de96137da391049d8b6

#else
#  define SWIG_init    init_md90de8bdc9357de96137da391049d8b6

#endif
#define SWIG_name    "_md90de8bdc9357de96137da391049d8b6"
...
SWIGINTERN PyObject *_wrap_cannon_integ(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CANNON *arg1 = (CANNON *) 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:cannon_integ",&obj0)) SWIG_fail;
  {
    // CANNON *
    void * temp_ptr ;
...
SWIGINTERN PyObject *_wrap_cannon_deriv(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CANNON *arg1 = (CANNON *) 0 ;
  PyObject * obj0 = 0 ;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:cannon_deriv",&obj0)) SWIG_fail;
  {
    // CANNON *
    void * temp_ptr ;
  ...
  result = (int)cannon_deriv(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "cannon_deriv" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_int out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_int out found units " << t->units << std::endl ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"cannon_integ", _wrap_cannon_integ, METH_VARARGS, NULL},
	 { (char *)"cannon_deriv", _wrap_cannon_deriv, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
